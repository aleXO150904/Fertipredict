package com.fertipredict.app.Jwt;
...
public class JwtService {
    ...
    @org.springframework.beans.factory.annotation.Value("${app.jwt.expiration-minutes:60}")
    ...
    private String getToken(Map<String, Object> extraClaims, UserDetails user) {
        return Jwts
            ...
            .setExpiration(new Date(System.currentTimeMillis() + java.time.Duration.ofMinutes(expirationMinutes).toMillis()))
